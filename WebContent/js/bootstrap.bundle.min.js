...
!function(t, e) {
    ...
    s = 1,
    {
        ...
        E.delete(t, e)
    }, O = Element.prototype.querySelectorAll, C = Element.prototype.querySelector, A = (a = new CustomEvent("Bootstrap",{
        cancelable: !0
    }),
                    ...
                    return function i(o) {
                        for (var r = t.querySelectorAll(e), s = o.target; s && s !== this; s = s.parentNode)
                            for (var a = r.length; a--; )
                                if (r[a] === s)
                                    return i.oneOff && V.off(t, o.type, n),
                                    n.apply(s, [o]);
                        return null
                    }
                }(t, n, i) : function(t, e) {
                    return function n(i) {
                        return n.oneOff && V.off(t, i.type, e),
                        e.apply(t, [i])
                    }
                }(t, n);
    ...
    var V = {
        ...
        trigger: function(t, e, n) {
            ...
            c && (u.preventDefault(),
            A || Object.defineProperty(u, "defaultPrevented", {
                get: function() {
                    return !0
                }
            })),
    ...
    var tt = {
      ...
      , at = function() {
        ...
        n.pause = function(t) {
            t || (this._isPaused = !0),
            et.findOne(".carousel-item-next, .carousel-item-prev", this._element) && (p(this._element),
            this.cycle(!0)),
        ...
        n._addTouchEventListeners = function() {
            var t = this
              ...
              , n = function(e) {
                t._pointerEvent && st[e.pointerType.toUpperCase()] && (t.touchDeltaX = e.clientX - t.touchStartX),
                t._handleSwipe(),
        ...
        n._getItemIndex = function(t) {
            return this._items = t && t.parentNode ? et.find(".carousel-item", t.parentNode) : [],
        ...
        n._slide = function(t, e) {
            var n, i, o, r = this, s = et.findOne(".active.carousel-item", this._element), a = this._getItemIndex(s), l = e || s && this._getItemByDirection(t, s), c = this._getItemIndex(l), u = Boolean(this._interval);
    ...
    V.on(document, "click.bs.carousel.data-api", "[data-slide], [data-slide-to]", at.dataApiClickHandler),
    ...
    var ut = "collapse"
      ...
      , dt = function() {
        function t(t, e) {
            ...
            this._element = t,
            this._config = this._getConfig(e),
            this._triggerArray = et.find('[data-toggle="collapse"][href="#' + t.id + '"],[data-toggle="collapse"][data-target="#' + t.id + '"]');
        ...
        n.show = function() {
            ...
            if (!this._isTransitioning && !this._element.classList.contains("show")) {
                ...
                if (n) {
                    ...
                    if ((i = r[0] ? L(r[0], "bs.collapse") : null) && i._isTransitioning)
                        return
                }
    ...
    var gt = "undefined" != typeof window && "undefined" != typeof document && "undefined" != typeof navigator
      , vt = function() {
        for (var t = ["Edge", "Trident", "Firefox"], e = 0; e < t.length; e += 1)
            if (gt && navigator.userAgent.indexOf(t[e]) >= 0)
                return 1;
        return 0
    }();
    ...
    function Wt(t, e) {
        ...
        return (i && !n ? e.contains(a) : e === a && "BODY" !== a.nodeName) && (f = xt(f, e)),
        f
    }
    function Ut(t) {
    ...
    function Jt(t, e, n) {
        return (void 0 === n ? t : t.slice(0, function(t, e, n) {
            ...
            t.enabled && bt(n) && (e.offsets.popper = Rt(e.offsets.popper),
    ...
    function ce(t, e) {
        Object.keys(e).forEach((function(n) {
            var i = "";
            -1 !== ["width", "height", "top", "right", "bottom", "left"].indexOf(n) && le(e[n]) && (i = "px"),
            t.style[n] = e[n] + i
        }
        ))
    }
        ...
        modifiers: {
            ...
            arrow: {
                ...
                fn: function(t, e) {
                    ...
                    t.arrowElement = i,
                    t.offsets.arrow = (Ht(n = {}, f, Math.round(b)),
                    Ht(n, h, ""),
                    n),
                    t
                },
            ...
            flip: {
                ...
                fn: function(t, e) {
                    ...
                    return s.forEach((function(a, l) {
                        ...
                        t.placement = i + (r ? "-" + r : ""),
                        t.offsets.popper = Bt({}, t.offsets.popper, $t(t.instance.popper, t.offsets.reference, t.placement)),
            ...
            computeStyle: {
                ...
                fn: function(t, e) {
                    ...
                    var s = void 0 !== r ? r : e.gpuAcceleration
                      ...
                      , p = void 0
                      , m = void 0;
                    if (m = "bottom" === f ? "HTML" === a.nodeName ? -a.clientHeight + u.bottom : -l.height + u.bottom : u.top,
            ...
            applyStyle: {
                ...
                fn: function(t) {
                    ...
                    t.arrowElement && Object.keys(t.arrowStyles).length && ce(t.arrowElement, t.arrowStyles),
                    t
                },
    ...
    var we = "dropdown"
      ...
      , ke = function() {
        ...
        ,
        n._getConfig = function(t) {
            return t = o(o(o({}, this.constructor.Default), tt.getDataAttributes(this._element)), t),
        ...
        t.dataApiKeydownHandler = function(e) {
            if (!(/input|textarea/i.test(e.target.tagName) ? "Space" === e.key || "Escape" !== e.key && ("ArrowDown" !== e.key && "ArrowUp" !== e.key || e.target.closest(".dropdown-menu")) : !Ee.test(e.key)) && (e.preventDefault(),
            e.stopPropagation(),
            !this.disabled && !this.classList.contains("disabled"))) {
                var n = t.getParentFromElement(this)
                  , i = this.classList.contains("show");
                if ("Escape" === e.key)
                    return (this.matches('[data-toggle="dropdown"]') ? this : et.prev(this, '[data-toggle="dropdown"]')[0]).focus(),
                    void t.clearMenus();
                if (i && "Space" !== e.key) {
    ...
    V.on(document, "keydown.bs.dropdown.data-api", '[data-toggle="dropdown"]', ke.dataApiKeydownHandler),
      ...
      , Se = function() {
        ...
        n._resetScrollbar = function() {
            et.find(".fixed-top, .fixed-bottom, .is-fixed, .sticky-top").forEach((function(t) {
                ...
                void 0 !== e && (tt.removeDataAttribute(t, "padding-right"),
                t.style.paddingRight = e)
            }
            )),
            et.find(".sticky-top").forEach((function(t) {
                var e = tt.getDataAttribute(t, "margin-right");
                void 0 !== e && (tt.removeDataAttribute(t, "margin-right"),
                t.style.marginRight = e)
            }
            ));
            var t = tt.getDataAttribute(document.body, "padding-right");
            void 0 === t ? document.body.style.paddingRight = "" : (tt.removeDataAttribute(document.body, "padding-right"),
        ...
        for (var o = (new window.DOMParser).parseFromString(t, "text/html"), r = Object.keys(e), s = (i = []).concat.apply(i, o.body.querySelectorAll("*")), a = function(t, n) {
            ...
            l.forEach((function(t) {
                (function(t, e) {
                    ...
                    if (-1 !== e.indexOf(n))
                        return -1 === Ie.indexOf(n) || Boolean(t.nodeValue.match(je) || t.nodeValue.match(Pe));
      ...
      , qe = function() {
        ...
        n.show = function() {
            ...
            if (this.isWithContent() && this._isEnabled) {
                ...
                if (T(o, this.constructor.DATA_KEY, this),
        ...
        n.setElementContent = function(t, e) {
            if (null !== t)
                ...
                t.appendChild(e)) : t.textContent = e.textContent)) : void (this.config.html ? (this.config.sanitize && (e = He(e, this.config.whiteList, this.config.sanitizeFn)),
    ...
    var nn = "scrollspy"
      ...
      , sn = function() {
        ...
        return n.refresh = function() {
            ...
            et.find(this._selector).map((function(t) {
                var e, o = f(t);
                if (o && (e = et.findOne(o)),
                e) {
                    var r = e.getBoundingClientRect();
                    if (r.width || r.height)
                        return [tt[n](e).top + i, o]
                }
                return null
            }
            )).filter((function(t) {
        ...
        n._activate = function(t) {
            ...
            var e = this._selector.split(",").map((function(e) {
              ...
              , n = et.findOne(e.join(","));
            n.classList.contains("dropdown-item") ? (et.findOne(".dropdown-toggle", n.closest(".dropdown")).classList.add("active"),
    ...
    var cn = function() {
        ...
        n._transitionComplete = function(t, e, n) {
            ...
            t.parentNode && t.parentNode.classList.contains("dropdown-menu")) && (t.closest(".dropdown") && et.find(".dropdown-toggle").forEach((function(t) {
                return t.classList.add("active")
            }
            )),
            t.setAttribute("aria-expanded", !0));
    ...
    V.on(document, "click.bs.tab.data-api", '[data-toggle="tab"], [data-toggle="pill"], [data-toggle="list"]', (function(t) {
        t.preventDefault(),
        (L(this, "bs.tab") || new cn(this)).show()
    }
    ));
    var un = w();
    if (un) {
    ...
    var hn = {
      ...
      , pn = function() {
        ...
        ,
        n._getConfig = function(t) {
            return t = o(o(o({}, dn), tt.getDataAttributes(this._element)), "object" == typeof t && t ? t : {}),
